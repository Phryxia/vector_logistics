...
!(function (e, t) {
  ...
  function $(e, t) {
    return _(e[t])
      ...
      : e.dataset
      ? e.dataset[t]
      : e.getAttribute('data-'.concat(U(t)))
  }
  function z(e, t, n) {
    _(n)
      ? (e[t] = n)
      : e.dataset
      ? (e.dataset[t] = n)
      : e.setAttribute('data-'.concat(U(t)), n)
  }
  var Z = /\s\s*/,
    G = (function () {
      var e = !1
      ...
      .forEach(function (i) {
        if (o.once && !G) {
          ...
          ;(c = function () {
            ...
            r[i] || (r[i] = {}),
            r[i][s] && a.removeEventListener(i, r[i][s], o),
            (r[i][s] = c),
            (a.listeners = r)
        }
  ...
  function te(e, t) {
    return [
      31,
      ((n = e), (n % 4 == 0 && n % 100 != 0) || n % 400 == 0 ? 29 : 28),
      31,
      30,
      31,
      30,
  ...
  var ae = {
      bind: function () {
        var e = this.element,
          t = this.options,
          n = this.grid
        V(t.show) && X(e, C, t.show),
          V(t.shown) && X(e, N, t.shown),
          V(t.hide) && X(e, u, t.hide),
          V(t.hidden) && X(e, h, t.hidden),
          V(t.pick) && X(e, p, t.pick),
          X(e, l, (this.onFocus = this.focus.bind(this))),
          X(e, c, this.onFocus),
          X(this.picker, c, (this.onClick = this.click.bind(this))),
          X(n, A, (this.onWheel = this.wheel.bind(this))),
          X(n, x, (this.onPointerDown = this.pointerdown.bind(this))),
          X(document, D, (this.onPointerMove = this.pointermove.bind(this))),
          X(document, S, (this.onPointerUp = this.pointerup.bind(this))),
          X(document, f, (this.onKeyDown = this.keydown.bind(this)))
      },
      unbind: function () {
        var e = this.element,
          t = this.options,
          n = this.grid
        V(t.show) && Q(e, C, t.show),
          V(t.shown) && Q(e, N, t.shown),
          V(t.hide) && Q(e, u, t.hide),
          V(t.hidden) && Q(e, h, t.hidden),
          V(t.pick) && Q(e, p, t.pick),
          Q(e, l, this.onFocus),
          Q(e, c, this.onFocus),
          Q(this.picker, c, this.onClick),
          Q(n, A, this.onWheel),
          Q(n, x, this.onPointerDown),
          Q(document, D, this.onPointerMove),
          Q(document, S, this.onPointerUp),
          Q(document, f, this.onKeyDown)
      },
    },
    se = {
      focus: function (e) {
      ...
      wheel: function (e) {
        ...
        if (t !== this.grid) {
          for (
            e.preventDefault();
            t.parentElement && t.parentElement !== this.grid;
      ...
      pointermove: function (e) {
        ...
        if (t) {
          ...
          ;(t.startY = n),
            (t.moveY = i),
            Math.abs(i) < t.maxMoveY
              ? (t.list.style.top = ''.concat(i, 'px'))
              : ((t.list.style.top = 0),
                (t.moveY = 0),
                i >= t.maxMoveY
                  ? this.prev(t.type)
                  : i <= -t.maxMoveY && this.next(t.type))
        }
      },
      pointerup: function (e) {
        ...
        t &&
          ...
          t.moveY >= t.minMoveY
            ? this.prev(t.type)
            : t.moveY <= -t.minMoveY && this.next(t.type),
          (this.cell = null))
      },
      keydown: function (e) {
    ...
    oe = {
        ...
        if (e) {
          ...
          for (var c = 0; c < n.rows + 2; c += 1) {
            var l = document.createElement('li'),
              ...
              u = r + h * i.increment
            o && (u %= o) < s && (u += o),
              (l.textContent = n.translate(
                e,
                i.aliases ? i.aliases[u] : ne(u + i.offset, i.digit)
              )),
              z(l, 'name', e),
              z(l, m, u),
              J(l, ''.concat(b, '-item')),
              0 === h && (J(l, d), (i.item = l)),
              i.list.appendChild(l)
          }
        } else
      ...
      current: function (e, t) {
        ...
        switch (r.charAt(0)) {
          case 'Y':
            return (
              T(t) &&
                (n.setFullYear(2 === r.length ? 2e3 + t : t),
                i.month && this.render(ie(i.month)),
                i.day && this.render(ie(i.day))),
              n.getFullYear()
            )
          case 'M':
            return (
              T(t) &&
                (n.setMonth(t, Math.min(n.getDate(), te(n.getFullYear(), t))),
                i.day && this.render(ie(i.day))),
              n.getMonth()
            )
          case 'D':
      ...
      setValue: function (e) {
        ...
        this.isInput
          ? (t.value = e)
          : this.options.container && (t.textContent = e)
      },
      open: function () {
        var e = this.body
    ...
    ce = {
      ...
      prev: function (e) {
        ...
        return (
          l < o && (l += s - o + 1),
          (a.textContent = t.translate(
            e,
            i.aliases ? i.aliases[l] : ne(l + i.offset, n.length)
          )),
          z(a, m, l),
          c && (q(i.item, d), J(c, d), (i.item = c)),
          r.insertBefore(a, r.firstElementChild),
          (i.current = Number($(i.item, m))),
          this.current(e, i.current),
          this.inline && t.container && this.pick(),
          this
        )
      },
      next: function (e) {
      ...
      pick: function () {
        ...
        return (
          this.setValue(t),
          this.isInput && !1 === ee(e, 'change') && this.reset(),
          this.hide(),
          this
        )
      },
      ...
      update: function () {
        return (
          (this.date = this.parseDate(this.getValue())), this.render(), this
        )
      },
      reset: function () {
        return (
      ...
      parseDate: function (o) {
        ...
        if (F(o)) {
          ...
          if (
            ((e = o.match(new RegExp('('.concat(t.join('|'), ')'), 'g'))) &&
              o.length === c.format.length &&
              e.length !== l.tokens.length &&
              (e = l.tokens.map(function (e) {
                return o.substr(c.format.indexOf(e), e.length)
              })),
            !e || e.length !== l.tokens.length)
          )
            return new Date()
        }
        var h = new Date()
    ...
    de = (function () {
      function n(e) {
        ...
        ;(this.element = e),
          (this.options = W({}, a, o[t.language], B(t) && t)),
          (this.shown = !1),
          this.init()
      }
      var e, t, i
            ...
            value: function () {
              ...
              if (!$(e, b)) {
                ...
                var r = i.getElementsByClassName(b)[0],
                  ...
                  a = h.container
                if ((F(a) && (a = document.querySelector(a)), n))
                  J(r, w), J(r, M), a || (a = e)
                else {
                  ...
                  ;(this.body = o),
                    (this.scrollBarWidth =
                      g.innerWidth - s.documentElement.clientWidth),
                    (this.initialBodyPaddingRight =
                      g.getComputedStyle(o).paddingRight),
                    J(r, ''.concat(b, '-fixed')),
                    a || (a = document.body)
                }
                ;(this.isInput = t),
                ...
                m % 2 || (m += 1),
                  ...
                  J(
                    u,
                    ''.concat(b, '-').concat(1 < h.rows ? 'multiple' : 'single')
                  ),
                  h.controls && J(u, ''.concat(b, '-controls'))
                var f = h.headers,
                  p = h.increment
                f && (J(u, ''.concat(b, '-headers')), (f = B(f) ? f : h.text)),
                  B(p) ||
                    (p = {
                      year: p,
                      month: p,
                  ...
                  this.format.tokens.forEach(function (e) {
                    ...
                    switch (e.charAt(0)) {
                      ...
                      case 'M':
                        ;(a.max = 11),
                          ...
                          (a.offset = 1),
                          3 === a.digit
                            ? (a.aliases = h.monthsShort)
                            : 4 === a.digit && (a.aliases = h.months)
                        break
                      case 'D':
                        ;(a.max = function () {
                    ...
                    if ((z(n, Y, t), z(n, 'token', e), f)) {
                      ...
                      J(s, ''.concat(b, '-cell__header')),
                        (s.textContent =
                          f[t] || t[0].toUpperCase() + t.substr(1)),
                        n.appendChild(s)
                    }
                    if (h.controls) {
                      var o = document.createElement('div')
                      J(o, ''.concat(b, '-cell__control')),
                        J(o, ''.concat(b, '-cell__control--prev')),
                        z(o, E, k),
                        n.appendChild(o)
                    }
                    if (
                      (J(r, ''.concat(b, '-list')),
                      J(i, ''.concat(b, '-cell__body')),
                      J(n, ''.concat(b, '-cell')),
                      J(n, ''.concat(b, '-').concat(t, 's')),
                      i.appendChild(r),
                      n.appendChild(i),
                      h.controls)
                    ) {
                      var c = document.createElement('div')
                      J(c, ''.concat(b, '-cell__control')),
                        J(c, ''.concat(b, '-cell__control--next')),
                        z(c, E, y),
                        n.appendChild(c)
                    }
